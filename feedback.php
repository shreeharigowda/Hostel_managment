    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                <h4 class="mb-3 mt-3">Feedback </h4>
                <br>
                <form class="needs-validation" action="insert_feedback.php" method="Post" novalidate="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="feedback_type" id="feedback_type"
                            placeholder="Positive or Negative">

                    </div>
                    <div class="mb-3">
                        <label for="feedback_details">Feedback Details</label>
                        <textarea name="feedback_details" id="feedback_details" cols="92" rows="10"
                            placeholder="Please enter your valuable feedback "></textarea>
                    ...
                    <button class="btn btn-primary btn-lg btn-block" type="submit"
                        name="feedback_submit">Submit</button>
                </form>
            </div>
        </div>
